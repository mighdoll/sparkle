...
case class PlotParameters(sources: Array[PlotSource], title: Option[String], units:Option[String])
...
object PlotParametersJson extends DefaultJsonProtocol {
  ...
  implicit val PlotParametersFormat = jsonFormat3(PlotParameters)
}
